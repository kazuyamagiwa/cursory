...
- [Ask Cursor to run the installer (chat Q&A)](#ask-cursor-to-run-the-installer-chat-qa)
...
See [Ask Cursor to run the installer (chat Q&A)](#ask-cursor-to-run-the-installer-chat-qa).
